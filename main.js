...
var yellowDude = document.querySelector(".yellow-dude")
var recieveMessageButton = document.querySelector(".recieve-message-button")
var messageText = document.querySelector(".message-text")
// Event listeners:
recieveMessageButton.addEventListener("click", hideYellowDude)
// Event handlers:
function hideYellowDude() {
    yellowDude.style.display = "none"
    messageText.innerText = "cabbage"
    console.log("cabbage")
}